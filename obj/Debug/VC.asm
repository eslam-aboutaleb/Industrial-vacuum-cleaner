...
r0x1005	res	1
r0x1006	res	1
_VC_Update_VC_Counter_1_55	res	2
_VC_Update_D_SW_Counter_1_55	res	2
;--------------------------------------------------------
; initialized data
;--------------------------------------------------------
...
;***
;entry:  _VC_Update	;Function start
; 2 exit points
;has an exit
;functions called:
;   _SW_GetState
...
;;	1028  _VC_Update_VC_Counter_1_55   offset=0
	BANKSEL	_VC_Update_VC_Counter_1_55
...
;;	1028  _VC_Update_D_SW_Counter_1_55   offset=0
	BANKSEL	_VC_Update_D_SW_Counter_1_55
...
;  pBlock Stats: dbName = C
;***
;entry:  _VC_GetSpeed	;Function start
; 2 exit points
;has an exit
;; Starting pCode block
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;	   91+   28 =   119 instructions (  294 byte)
